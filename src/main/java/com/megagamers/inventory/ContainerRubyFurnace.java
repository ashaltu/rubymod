package com.megagamers.inventory;
...
public class ContainerRubyFurnace extends Container{
	...
	private TileEntityRubyFurnace tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public ContainerRubyFurnace(InventoryPlayer player, TileEntityRubyFurnace tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(TileEntityRubyFurnace.isItemFuel(itemstack1)){
