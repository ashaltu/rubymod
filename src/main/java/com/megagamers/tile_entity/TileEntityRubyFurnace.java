...
import com.megagamers.blocks.RubyFurnace;
...
public class TileEntityRubyFurnace extends TileEntity implements ISidedInventory{
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.furnaceName : "Ruby Furnace";
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			RubyFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
